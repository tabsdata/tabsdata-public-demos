...
from tabsdata_mindbody_plugins import MindbodySalesSource
...
@td.publisher(
    ...
    tables=["purchases_bronze"],
)
def purchases_pub(tf: td.TableFrame) -> td.TableFrame:
    return tf
